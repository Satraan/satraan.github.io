                    ...
                    <ul>
                        <li>
                            ...
                            <Showcase title={"Sweepsouth"}
                                ...
                                <ul>
                                    <li>
                                        Make & manage bookings for a variety of services
                                    </li>
                                    <li>
                                        Adaptable bookings funnel to handle a multiservice model
                                    </li>
                                    <li>
                                        Region-dependant content

                                    </li>
                                    <li>
                                        Account system with subscription bookings
                        ...
                        <li>
                            <Showcase title={"DoubleExposure"}
                                      ...
                                      tags={["HTML", "Semantic UI", "CSS", "Groovy", "Grails"]}>
                                <ul>
                                    <li>
                                        Photography & album hosting
                                    </li>
                                    <li>
                                        Upload and browse large galleries of photos
                                    </li>
                                    <li>Order physical prints</li>
                                    <li>Manage events as a photographer</li>
                                </ul>
                        ...
                        <li>
                            <Showcase title={"Portfolio app"}
                                      src={"https://www.doubleexposure.co/assets/app/logos/logo-doubleexposure-1000x161-6d78231d57d346694d56c15552c280f7.png"}
                                      link={"https://www.doubleexposure.co/"}
                                      tags={["HTML", "SCSS", "Firebase"]}>
                                <ul>
                                    <li>
                                        Static site to advertise dev business
                                    </li>
                                </ul>
